...
The .py scripts are used to read the simulation data stored in the "result" folder (which should be first extracted from the result.rar file) and then plot figures that are shown in the manuscript.
